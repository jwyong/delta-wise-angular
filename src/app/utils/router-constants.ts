...
export class RouterConstants {
     ...
     * auth
     */
    public static ROUTER_PATH_LOGIN: string = '';
    public static ROUTER_PATH_FORGOT_PWORD: string = 'forgot-pword';
    public static ROUTER_PATH_RESET_PWORD: string = 'reset-pword';
